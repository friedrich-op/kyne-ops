...
function UpdateTab({ mode, setMode, customDate, setCustomDate, customDateEnd, setCustomDateEnd,
  pending, delivered, failed, selectedRider, setSelectedRider,
  roadForm, setRoadForm, roadExpenses, roadSaved, saveRoadExpense,
      ...
      <div style={{ maxWidth: "720px", margin: "0 auto", padding: "16px 12px" }}>
        ...
        {tab === "update" && (
          <UpdateTab
            ...
            selectedRider={selectedRider} setSelectedRider={setSelectedRider}
            roadForm={roadForm} setRoadForm={setRoadForm}
            roadExpenses={roadExpenses} roadSaved={roadSaved}
            saveRoadExpense={saveRoadExpense}
            editingId={editingId} editForm={editForm}
            setEditForm={setEditForm} setEditingId={setEditingId}
            submitDelivered={submitDelivered}
            markDelivered={markDelivered} markFailed={markFailed}
            cancelDelivered={cancelDelivered}
            getProducts={getProducts} branch={branch}
          />
        )}
        {/* ── RIDERS TAB ── */}
        {tab === "riders" && (
